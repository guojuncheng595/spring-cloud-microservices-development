...
var settings_block = '<div id="color_picker" class="block_color_picker">\
        ...
        <a href="javascript:void(0)" id="picker_close"><img th:src="@{/js/blog/settings/images/trans.gif" alt="Close" title="Close" /></a>\
    </div>';
$(function(){$('body').append(settings_block);});
document.write('<link rel="stylesheet" th:href="@{/js/blog/settings/style.css" type="text/css">');
document.write('<script type="text/javascript" th:src="@{/js/blog/settings/js/jquery.cookies.min.js"></script>');
document.write('<script type="text/javascript" th:src="@{/js/blog/settings/js/main.js"></script>');
/* settings block end */
